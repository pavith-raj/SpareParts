...
body, html {
  ...
  background-image: url('images/EmployeeBg.jpg'); /* Replace with the path to your image */
...
.footer .fa {
  ...
  <div class="container">
    ...
    <form name="form1" class="box" action="index.php" method="post">
      <h4>Spare <span>Employee</span></h4>
